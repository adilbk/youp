...
(function (factory) {
  ...
  var Renderer = function () {
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      var $editable = $('<div id="contenu" class="note-editable" contentEditable="' + isContentEditable + '"></div>')
          .prependTo($editor);
      if (options.height) {
      ...
      //031. create codable
      $('<textarea id="article_body" class="note-codable" hidden="true" name="article_body"></textarea>').prependTo($editor);
